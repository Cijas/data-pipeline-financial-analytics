...
class TestTransformation:
    ...
    def sample_data(self):
        ...
        return pd.DataFrame({
            ...
            "customer_id": ["CUST_001", "CUST_002", "CUST_001", "CUST_002"],
            "transaction_date": pd.date_range("2024-01-01", periods=4),
            "amount": [100.0, -50.0, 200.0, 150.0],
            "category": ["Food", "Food", "Shopping", "Entertainment"],
    ...
    def test_data_cleaning(self, sample_data):
        ...
        assert len(cleaned) == 3  # One negative amount removed
